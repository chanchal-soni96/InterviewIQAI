...
const Step2Interview = ({interviewData, onFinish}) => {
  ...
  const isRecognitionRunning = useRef(false);  // ✅ ADD HERE
...
const startMic = () => {
  if(recognitionRef.current && !isAIPlaying
      && !isRecognitionRunning.current )  // ✅ ADD THIS LINE
...
useEffect(() =>{
  ...
  return (
    ...
    <div className='min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6'>
      {/*Work Flow: Mount- Load Voice- Intro Speak- Question Speak- Mic ON- Timer Running- Submit- Feedback Speak- Next Question- Report- Finish  */}
...
{isMicOn ? <FaMicrophone size={20}/> : <FaMicrophoneSlash size={20}/>}
    ...
    whileTap={{scale:0.95}}
    className='flex-1 bg-gradient-to-r from-emerald-600 to-teal-500 text-white py-3 
    sm:py-4 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold disabled:bg-gray-500'>
