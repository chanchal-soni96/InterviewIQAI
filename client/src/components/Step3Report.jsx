...
const Step3Report = ({ report }) => {
  ...
  if (finalScore >= 8) {
    ...
    shortTagline = "Exellent clearity and structured responces.";
  } else if (finalScore >= 5) {
    performanceText = "Needs minor improvement before interviews.";
    shortTagline = "Good foundation, refine articulation.";
  } else {
    performanceText = "Significant improvement requied.";
  ...
  const downloadPDF = () =>{
    ...
    if(finalScore >= 8){
      advice = 
     "Excellent performance. Maintain confidence and structure. Continue refining clearly and supporting answers with strong real-world examples.";
      
    }else if(finalScore >= 5){
      advice =
      "Good foundation shown. Improve clarity and structure. Practice delivering concise, confident answer with stronger supporting exaples.";
    }else{
      advice = 
    ...
    autoTable(doc, {
      ...
      columnStyles: {
        0: { cellWidth: 10, helign: "center" }, // index
        1: { cellWidth: 55 }, // question
        2: { cellWidth: 20, helign: "center" }, // score
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4">
                <div>
                  ...
                  <p className="font-semibold text-gray-800 text-sm sm:text-base leading-relaxed">
                    {q.question || "Question not availble"}
                  </p>
                </div>
